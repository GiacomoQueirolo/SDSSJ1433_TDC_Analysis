...
def plt_sup_corner_lnsprm(setting_list,smpl_mcmc=None,prm_mcmc=None,stnd_lnsprm=False,ign_lnsprm_qphi=False,
                    col=base_colors,savefig_dir=None,cut_mcmc=None,simple_legend=False,backup_path="backup_results/"):
...
if __name__=="__main__":
    ...
    if not ign_Df:
        plot_sup_corner_Df(setting_name,savefig_dir=save_dir,cut_mcmc=cut_mcmc,simple_legend=simple_legend,param_names=param_names,backup_path=backup_path)
     
    if stnd_lnsprm or not ign_lnsprm_qphi:
        plt_sup_corner_lnsprm(setting_name,smpl_mcmc=None,prm_mcmc=None,stnd_lnsprm=stnd_lnsprm,ign_lnsprm_qphi=ign_lnsprm_qphi,\
                                savefig_dir=save_dir,cut_mcmc=cut_mcmc,simple_legend=simple_legend,backup_path=backup_path)
    success(sys.argv[0])
