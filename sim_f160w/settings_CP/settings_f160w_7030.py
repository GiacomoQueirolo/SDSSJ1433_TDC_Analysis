...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_mkSource_SC_ws.py: Just for the modelling, reduce mask to stricly what is necessary"
        ...
        x_mask=[68.248796, 64.178856, center_x_pix-1]
        y_mask=[71.54351, 32.588364,center_y_pix-1]
        self.r_mask=[6.0562063, 5.4533765,3]
