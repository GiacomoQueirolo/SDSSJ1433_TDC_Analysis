...
from Prior.Prior import get_prior
...
if __name__=="__main__":
    parser = argparse.ArgumentParser(description="Produces the prior of the source parameters given the setting file. If multiple setting files, also produce superposed corner plot")
