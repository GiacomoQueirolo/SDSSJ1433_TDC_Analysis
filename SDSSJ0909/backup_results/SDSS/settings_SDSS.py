...
import ..util.conversion_SDSS 
import ..util.image_manipulation_SDSS
conv = conversion_SDSS.conv_5
find_barycenter = conversion_SDSS.find_barycenter
extract_q_ll = image_manipulation_SDSS.extract_q_ll
extract_phi_ll = image_manipulation_SDSS.extract_phi_ll
get_transf_matrix = image_manipulation_SDSS.get_transf_matrix
...
class setting():
    ...
    def __init__(self):
        ...
        self.data_path   = "./data/"
        self.image_name  = "extr_r.fits.fits"
        self.err_name    = "e.fake_err_r.fits"
        ...
        self.x_image, self.y_image,self.x_forgr,self.y_forgr, self.center_x, self.center_y, self.pix_scale, self.ra_at_xy_0,self.dec_at_xy_0= \
	        conv (x_im_pix,y_im_pix,center_x_pix,center_y_pix,x_forgr,y_foregr ,self.transform_pix2angle,self.ra_at_xy_0,self.dec_at_xy_0)
