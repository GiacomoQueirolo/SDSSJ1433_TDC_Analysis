...
class setting():    
    def __init__(self):
        ...
        self.comments="Change wrt settings_f475w_SP_ws gamma -> gamma_ext and psi -> psi_ext not to confuse with the gamma of the PEMD profile (and not setting_file_name)"   
        #Perturber
        R_sersic_lens = 0.363
