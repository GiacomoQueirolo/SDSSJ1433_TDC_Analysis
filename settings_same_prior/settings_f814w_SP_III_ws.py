...
class setting():
    def __init__(self):
        ...
        self.comments="Change wrt settings_f814w_SP_II_ws: using same_prior_I, different prior for theta_E_1"
        ...
        x_im_pix = [114.882, 92.899, 51.0978, 39.794]
        y_im_pix = [109.799, 57.130,  39.6647, 103.96]
        self.z_source = 2.737
        self.z_lens= 0.407
