...
from same_prior_ellipt_II import lens_prior
...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f814w_SP_ellipt_III_ws: new lens light model"
        ...
        self.phi_ll = extract_phi_ll(model_name=self.lens_light_model_name,setting=self,min_ra=lens_prior.theta_E)#TMP find the correct model #
        #Mask coord
        ###########
