...
def get_setting_refPoint(setting):
    # output the center/point of reference for the setting file in pixel
    # by construction is image A
    sett = get_setting_module(setting,True)
    Ax,Ay = sett.x_image[0],sett.y_image[0] #should be 0,0 by construction
