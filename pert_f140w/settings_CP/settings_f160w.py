...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL2_mask31_I_SC_ws.py: Just for this model, reduce mask to stricly what is necessary"
        ...
        #Mask coord
        ###########
        x_mask=[71.403101, 75.665054, 75.665054, 68.935655,center_x_pix]
        y_mask=[72.076041, 71.178788, 81.048574, 32.484742,center_y_pix] # coord in pixel in the HST image 
        #radius of the mask for the object in pixels        
        self.r_mask=[3.4505953, 3.8606879, 3.9444751, 5.3961413,3]
