...
class ModelBandPlot(ModelBand):
    ...
    def model_plot(self, ax, v_min=None, v_max=None, image_names=False,
                   colorbar_label=r'log$_{10}$ flux',return_arr=False,
        ...
        :param v_min:
        :param v_max:
        # my addition : return_arr: bool, so that we can easily obtain the numerical image of the resulting model (other ways should be possible)
        :return:
        """
        if return_arr==True:
            return self._model
