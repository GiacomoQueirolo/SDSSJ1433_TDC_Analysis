...
from Custom_Model.my_lenstronomy.My_Plots.model_band_plot import ModelBandPlot
...
class ModelPlot(object):
    ...
    def model_plot(self, band_index=0,return_arr=False, **kwargs):
        """
        illustrates model
        ...
        plot_band = self._select_band(band_index)
        if return_arr is False:
            return plot_band.model_plot(**kwargs)
        else:
            return plot_band.model_plot(ax=None,return_arr=True,**kwargs)
