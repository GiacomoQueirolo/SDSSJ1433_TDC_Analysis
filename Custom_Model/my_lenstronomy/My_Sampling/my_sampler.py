...
from Custom_Model.my_lenstronomy.My_Sampling.Samplers.my_pso import MyParticleSwarmOptimizer
...
class MySampler(object):
    ...
    def my_pso(self, n_particles, n_iterations, lower_start=None, upper_start=None,
        ...
        pso = MyParticleSwarmOptimizer(self.chain.logL,
                                     lower_start, upper_start, n_particles,
                                     pool=pool,path=path,name=name)
