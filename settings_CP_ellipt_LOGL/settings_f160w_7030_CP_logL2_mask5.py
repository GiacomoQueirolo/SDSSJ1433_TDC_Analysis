...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL_VI.py: ~size as mask 4 but different shape"

        self.data_path  = "./data/F160W_7030/"
        self.image_name = "eF160W_qso_7030.fits"
        self.err_name   = "e.eF160W_qso_7030.fits"

        self.psf_name   = "psf_0005_F160W_7040.fits"
        self.err_psf    = "e.psf_0001_F160W_7040.fits"
