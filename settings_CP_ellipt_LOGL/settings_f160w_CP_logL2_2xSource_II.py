...
from conversion import find_barycenter,conv_general
...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL2_FS.py: Considering the 2xSource model"

        self.data_path  = "./data/F160W/"
        self.image_name = "skycorr_qso_F160W_arno.fits"
        self.err_name   = "e.skycorr_qso_F160W_arno.fits"

        self.psf_name   = "psf_0005_corr_7040.fits"
        self.err_psf    = "e.psf_0001_corr_7040.fits"
        ...
        # MOD_FreeSource
        self.FS = True # pos of source free from pos of qso
        #Mask coord
        ###########
        x_mask=[52.0, 66.34303, 69.088625] # center and bottom ext light
        y_mask=[52.0, 32.426858, 71.672715]
        self.r_mask=[3.0, 5.4400451, 4.0850344]
        ...
        #px_source_2,py_source_2 = 62,65
        #[[x_source_2,y_source_2]] ,_,_ = conv_general([x_im_pix[0],y_im_pix[0]],[[px_source_2,py_source_2]],self.transform_pix2angle,[self.ra_at_xy_0,self.dec_at_xy_0])
        # from find_2xSource
        # already in arcsec wrt A
        x_source_2,y_source_2 = 0.5136679237491119, -1.77928108426568
        fixed_source.append({})
        kwargs_source_init.append({'amp' : 0,'R_sersic': R_sersic_source/5. ,
				                'n_sersic': n_sersic_source, 
				                'center_x': x_source_2, 
				                'center_y': y_source_2})
        kwargs_source_sigma.append({'amp': 0,'R_sersic': sg_R_sersic_source*3/5., 
				                'n_sersic': n_sersic_source*3, 
				                'center_x': sg_x_source*10, 
				                'center_y': sg_y_source*10})
        kwargs_lower_source.append({'amp': 0,'R_sersic': R_sersic_source/5. - (sg_R_sersic_source*9) , 
				                'n_sersic': 1., 
				                'center_x': x_source_2 - (sg_x_source*15), 
				                'center_y': y_source_2 - (sg_y_source*15)})
        kwargs_upper_source.append({'amp': 0,'R_sersic': R_sersic_source/5. + (sg_R_sersic_source*9) , 
				                'n_sersic': 7., 
				                'center_x': x_source_2 + (sg_x_source*15), 
				                'center_y': y_source_2 + (sg_y_source*15)})
