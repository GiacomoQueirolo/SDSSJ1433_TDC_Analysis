...
class setting():
    ...
    def __init__(self):
        ...
        self.comments="Change wrt settings_f140w_CP_logL2_SC.py: mod free source FS"   
        ...
        x_im_pix = [26.3015 , 36.6658 , 54.291 , 42.815] #-> wrong order
        y_im_pix = [37.9818 , 28.5979 , 29.437 , 49.3211]
        ...
        # MOD_FreeSource
        self.FS = True # free source pos wrt qso pos
