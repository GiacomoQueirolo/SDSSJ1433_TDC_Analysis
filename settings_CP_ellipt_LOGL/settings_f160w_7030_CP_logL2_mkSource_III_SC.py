...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_mkSource_SC: with source but mask ~3.2, covering the light we see from sim_f160 (WS=FS=False)"
        ...
        self.x_mask=np.array([58.133163, 49.519532, 52.076704, 68.36185, 40.367549, 64.324211, 63.247507, 64.189623, 67.68891]) -1
        self.y_mask=np.array([64.324211, 37.675789, 37.675789, 52.749644, 47.096948, 44.405189, 43.328485, 42.655545, 55.306816])-1
        self.r_mask=[2.2660747, 2.3191084, 1.6367102, 1.7965229, 2.5953499, 1.2805463, 1.1716638, 1.0110638, 2.4422652]
