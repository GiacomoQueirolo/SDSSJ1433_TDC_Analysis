...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL2_mask31_I_SC.py: mod Free Source "
        ...
        #Mask coord
        ###########
        x_mask = [72.5,77.5,82.8,76.1,88.4,47,54,69.,78,101,52, 61,51,51,53,41]
        y_mask = [71.8,69.87,68.2,80.48,46.4,100,101,32,26,52,52,66,37,38,38,41] # coord in pixel in the HST image 
        #radius of the mask for the object in pixels
        self.r_mask = [3.9,2.33,2.33,3.42,3.42,3,2,2.5,2,1,3,7,1,1,1,5]
