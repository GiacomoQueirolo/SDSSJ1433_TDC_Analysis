...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL_V.py: just to test the psfs"

        self.data_path  = "./data/F160W_7030/"
        self.image_name = "eF160W_qso_7030.fits"
        self.err_name   = "e.eF160W_qso_7030.fits"

        self.psf_name   = "psf_0005_skycorr_3stars_edge35_corr.fits"#"psf_0005_2stars_edge21.fits"#"corr_psf_0005_3stars_edge35.fits"
        self.err_psf    = "e.psf_0001_skycorr_3stars_edge35_corr.fits"#"e.psf_0001_2stars_edge21.fits"#"e.psf_0001_3stars_edge35.fits"
        ...
        self.pssf = 5#5#5 #point source supersampling factor -> how much the PSF was supersampled
        self.ssks = 71#43#71	#it should be the size of the non-supersampled kernel in pixel
        ...
        self.r_mask = [3]
        self.x_mask,self.y_mask = np.array([49.])-1,np.array([52.])-1
