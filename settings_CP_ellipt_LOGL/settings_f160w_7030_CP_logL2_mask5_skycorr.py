...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_mask5.py: Image with sky correction & new psf model"
        ...
        self.x_mask =  np.array([49.,40.,60.,57.])-1
        self.y_mask = np.array([52.,43.,64.,62.])-1
        self.r_mask = [3,4,4,3]
