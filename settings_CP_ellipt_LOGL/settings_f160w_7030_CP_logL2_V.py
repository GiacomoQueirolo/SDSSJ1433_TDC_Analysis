...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL_IV.py: mask the source and the center of the lens and new PSF model"

        self.data_path  = "./data/F160W_7030/"
        self.image_name = "eF160W_qso_7030.fits"
        self.err_name   = "e.eF160W_qso_7030.fits"

        self.psf_name   = "psf_0001_maybe_7030.fits"
        ...
        self.pssf = 1#5 #point source supersampling factor -> how much the PSF was supersampled
