...
class setting():
    ...
    def __init__(self):
        ...
        self.comments="Change wrt settings_f140w_CP_logL2_SC_I.py: Added perturber close to the arc and repeat the analysis without changing anything - see if we can have similar results/results pertubed as much as f160w"   
        ...
        self.data_path  = "./data/F140W/sim_pert/"
        self.image_name = "pert_f140w.fits"
        self.err_name   = "e.pert_f140w.fits"
