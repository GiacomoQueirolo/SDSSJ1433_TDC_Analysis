...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL2_I_ws.py: with mask3.1 ( mask4 + enlarged lower mask) masking, use data with subtracted light model from settings_f160w_CP_logL2_mask3.py"

        self.data_path  = "./data/F160W/sub_source/"
        self.image_name = "sub_qso_F160W_arno.fits"
