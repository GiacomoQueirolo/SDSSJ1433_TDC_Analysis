...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_mkSource_I_SC: Try again but now with the updated HST_Main to be sure it's compatible"

        self.data_path  = "./data/F160W_7030/"
        self.image_name = "skycorr_eF160W_qso_7030.fits"
        self.err_name   = "e.skycorr_eF160W_qso_7030.fits"

        self.psf_name   = "psf_0005_skycorr_3stars_edge35_corr.fits"
        self.err_psf    = "e.psf_0001_skycorr_3stars_edge35_corr.fits"
        ...
        center_x_pix,center_y_pix = 49.2789, 51.9701
        #For the perturber
        x_pert_pix,y_pert_pix = 62.0, 42.4429
        # Parameters for the source
        # order A (top), C (right), B (bottom),D (left)
        x_im_pix =[65.459 , 58.5911, 45.6961, 42.3847] 
        y_im_pix = [58.94  , 42.6603, 37.3016, 56.9967]
        ...
        self.FS = False # Free Source
        #Mask coord
        ###########
        #radius of the mask for the object in pixels 
        self.x_mask =  np.array([49.,59.383623, 60.735821, 61.709403, 57.057844, 68.254038, 66.901841, 50.026418, 52.568549, 54.515713, 64.251534, 64.738325, 62.358458, 41.534619, 39.96607, 60.681733, 56.084262, 60.789909, 61.979842,64.630149])-1
        self.y_mask = np.array([52.,64.792413, 63.548391, 62.250282, 63.0616, 55.813822, 54.245274, 37.153499, 37.153499, 38.343433, 54.569801, 51.486791, 48.728308, 38.505697, 43.427695, 46.618881, 39.587455, 60.735821, 46.240265,33.962314])-1
        
        self.r_mask = [3,1.2082268, 1.3481647, 1.3722214, 1.5765744, 1.1342596, 1.8621656, 2.1013423, 2.4665338, 1.522816, 1.3800865, 2.1780095, 1.7592496, 1.9072627, 2.3867985, 1.0942564, 1.1166415, 0.99540216, 0.94773499,4.8991378]   
