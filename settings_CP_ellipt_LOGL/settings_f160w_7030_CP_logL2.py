...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL.py: adapted for 7030 instead of the 7040 observation"

        self.data_path  = "./data/F160W_7030/"
        self.image_name = "F160W_qso_7030.fits"
        self.err_name   = "e.F160W_qso_7030.fits"

        self.psf_name   = "psf_f160w_7030.fits"
        self.err_psf    = "e.psf_f160w_7030.fits"
