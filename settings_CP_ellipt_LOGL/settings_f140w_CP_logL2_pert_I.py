...
class setting():
    ...
    def __init__(self):
        ...
        self.comments="Change wrt settings_f140w_CP_logL2_pert.py: perturber more similar to f160w -> same pos and (aperture) brightness (not adapted for different filter)"   
        ...
        self.image_name = "pert_f140w_1.fits"
        self.err_name   = "e.pert_f140w_1.fits"
