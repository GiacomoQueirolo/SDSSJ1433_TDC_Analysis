...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f814w_CP_logL2_II_ws: just to test the new psf model"
        ...
        self.psf_name    = "psf_0005_newAB.fits"# psf_0005_new.fits"
        self.err_psf     = "e.psf_0001_newAB.fits" #psf_0001_new.fits"
