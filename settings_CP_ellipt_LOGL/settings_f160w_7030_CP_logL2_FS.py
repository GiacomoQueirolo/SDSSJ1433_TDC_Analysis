...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_mkSource_SC: with less mask and mod free source"
        ...
        self.FS = True # MOD Free Source

        #Mask coord
        ###########
        #radius of the mask for the object in pixels 
        self.x_mask=np.array([66.859574, 49.2789])-1
        self.y_mask=np.array([32.625001, 51.9701])-1
        self.r_mask=[4.9754824, 3.0]
