...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL2.py: masking more the upper feature"
        ...
        #Mask coord
        ###########
        x_mask = [72.5,77.5,82.8,76.1,88.4,47,54,69.,78,101,52, 61]
        ...
        self.r_mask = [3.9,2.33,2.33,3.42,3.42,3,2,2.5,2,1,3,4.2]
