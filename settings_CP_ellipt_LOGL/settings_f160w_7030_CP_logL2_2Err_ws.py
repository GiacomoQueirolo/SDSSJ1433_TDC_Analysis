...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_mkSource_SC_ws.py: test with error *2"

        self.data_path  = "./data/F160W_7030/"
        self.image_name = "skycorr_eF160W_qso_7030.fits"
        self.err_name   = "e.x2_skycorr_eF160W_qso_7030.fits"

        self.psf_name   = "psf_0005_skycorr_3stars_edge35_corr.fits"
        self.err_psf    = "e.x2_psf_0001_skycorr_3stars_edge35_corr.fits"
