...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL2_mask31_I_SC.py: Mask ALL the source (==f160_7030 mkSource) but still model it"
        ...
        self.FS = False #Fixed Source
        
        #Mask coord
        ###########
        x_mask=[51.880869, 62.265568, 63.618126, 64.591295, 59.939277, 71.135849, 69.783065, 52.908217, 55.448805, 57.396624, 67.132842, 67.619632, 65.239199, 44.415216, 42.846641, 63.56337, 58.96526, 63.671408, 64.860532, 67.51149]
        y_mask=[52.171124, 64.962217, 63.718501, 62.421728, 63.231171, 55.984368, 54.414431, 37.325378, 37.32327, 38.514367, 54.740472, 51.657813, 48.89764, 38.676131, 43.598851, 46.790408, 39.758536, 60.905468, 46.409826, 34.133001]
        #radius of the mask for the object in pixels
        self.r_mask=[3.0019493, 1.208577, 1.3489279, 1.3723197, 1.5750487, 1.1306043, 1.8635477, 2.0974658, 2.4639376, 1.5204678, 1.3801169, 2.1754386, 1.7621832, 1.9103313, 2.3859649, 1.0916179, 1.1150097, 0.99805066, 0.95126704, 4.8966861]
