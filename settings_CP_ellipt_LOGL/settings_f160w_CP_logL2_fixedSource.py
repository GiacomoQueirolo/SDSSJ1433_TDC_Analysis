...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL2_FS.py: not FS but mask copied from f140w_CP_logL2_SC_I"
        ...
        # MOD_FreeSource
        self.FS = False # pos of source free from pos of qso
        #Mask coord
        ###########
        ...
        fixed_source = [{'R_sersic': 0.476014224821917, 'n_sersic': 6.614314130630339, 'center_x': 0.4272849623126601, 'center_y': -1.759981239390604}]
        kwargs_source_init = [{'amp' : 1}]
        kwargs_source_sigma = [{'amp': 0.5}]
        kwargs_lower_source = [{'amp': 0}]
        kwargs_upper_source = [{'amp': 1e10}]
