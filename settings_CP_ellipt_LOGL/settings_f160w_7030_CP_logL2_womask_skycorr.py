...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_mask5_skycorr.py: W/o mask 5, check if in this image is really necessary"
        ...
        self.x_mask =  np.array([49.])-1
        self.y_mask = np.array([52.])-1
        self.r_mask = [3]
