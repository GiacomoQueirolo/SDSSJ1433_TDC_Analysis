...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f814w_CP_logL2_III_ws: new psf model"
        ...
        self.err_name    = "e.newerror_f814w.fits"
        self.psf_name    = "psf_0005_f814w_psfretry.fits"#"psf_0005_newAB.fits"# psf_0005_new.fits"
        self.err_psf     = "e.psf_0001_f814w_psfretry.fits"#"e.psf_0001_newAB.fits" #psf_0001_new.fits"
