...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_mk6_SC.py: we try masking all the light from the source (see data/F160W_7030/masksource.png) and modelling ws"
