...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_7030_CP_logL2_womask_skycorr.py: now with smaller mask as mask5"
        ...
        self.x_mask =  np.array([49.,67.,x_pert_pix,57.])-1
        self.y_mask = np.array([52.,32.,y_pert_pix,62.])-1
        self.r_mask = [3,6,1,3]
