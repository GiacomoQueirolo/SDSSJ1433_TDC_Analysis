...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f160w_CP_logL2_mask31_I_SC.py: mask 3.1 -> mask 3.2 s.t. all light from the sim_f160w study is masked"
        ...
        #Mask coord
        ###########
        x_mask = [72.5,77.5,82.8,76.1,88.4,47,54,69.,78,101,52, 61,51,51,53,41,61.993965, 52.30363, 45.035879, 54.403203, 39.867701]
        y_mask = [71.8,69.87,68.2,80.48,46.4,100,101,32,26,52,52,66,37,38,38,41,64.855844, 37.23839, 39.337962, 37.23839, 42.245063]
        #radius of the mask for the object in pixels
        self.r_mask = [3.9,2.33,2.33,3.42,3.42,3,2,2.5,2,1,3,7,1,1,1,5,3.0836347, 2.0252366, 2.4439615, 1.6200827, 2.868314]
