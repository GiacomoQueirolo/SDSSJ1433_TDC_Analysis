...
class setting():
    ...
    def __init__(self):        
        ...
        self.comments="Change wrt settings_f105w_CP_logL2_ws: sky corrected image and psf"
        ...
        self.psf_name    = "psf_skycorr_F105W.fits"
        self.err_psf     = "e.psf_skycorr_F105W.fits"
