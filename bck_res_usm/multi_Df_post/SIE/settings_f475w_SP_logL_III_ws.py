...
class setting(): 
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f475w_SP_ellipt_logL_II_ws: small changes in the code and new lens model"
        #Perturber
        R_sersic_lens    = 0.363
        ...
        self.lens_light_model_name = "model_tot_f475w_220527.fits" 
        ...
        # MOD_CUSTOM_LIKE
        self.phi_ll = extract_phi_ll(model_name=self.lens_light_model_name,setting=self,min_ra=lens_prior.theta_E)
