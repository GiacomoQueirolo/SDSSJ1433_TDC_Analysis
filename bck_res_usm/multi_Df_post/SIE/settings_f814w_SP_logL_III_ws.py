...
from image_manipulation import extract_phi_ll,get_transf_matrix
...
class setting():
    ...
    def __init__(self):
        ...
        self.comments = "Change wrt settings_f814w_SP_ellipt_logL_II_ws: change in the code and new model"
        ...
        self.lens_light_model_name = "model_tot_f814w_220527.fits" 
        ...
        # MOD_CUSTOM_LIKE
        self.phi_ll = extract_phi_ll(model_name=self.lens_light_model_name,setting=self,min_ra=lens_prior.theta_E)#TMP find the correct model # extract_phi_ll(model_name="outdata_model_f814w.fits",setting=self,min_ra=lens_prior.theta_E)
        ...
        kwargs_lens_sigma.append({'center_x': 1.5*self.pix_scale, 
			                      'center_y': 1.5*self.pix_scale,
